...
Upstream \gls{ac:iam} providers like onelogin are to be supported by implementing \gls{ac:m8} authentication flow as described in section \todo{add section ref}.
...
\mytable{tab:abuc}{
  \begin{tabularx}{\linewidth}{| l l X |}
    ...
    UC07 & \Copy{abuc07}{\gls{ac:csv} audit-log reports export} & As an auditor, I want to export audit-log reports in a \gls{ac:csv} formatted file \gls{ac:gui} \\

    UC08 & \Copy{abuc08}{Send audit-log reports via e-mail} & As an auditor, I want to send audit-log reports via e-mail \gls{ac:gui} \\
    \hline
  \end{tabularx}
}{\Gls{gl:ab} derived use-cases}
...
\includenamedsvg{\includesvg[width=\textwidth]}{diagrams/audit_browser/audit_browser_business_context.drawio}{\Gls{gl:ab} business context diagram}

\subsubsection{Technical Context}

\includenamedsvg{\includesvg[width=\textwidth]}{diagrams/audit_browser/audit_browser_technical_context.drawio}{\Gls{gl:ab} technical context diagram}
...
\mytable{abapicbbbb}{
  \begin{tabularx}{\linewidth}{|l X |}
    ...
    \hline
  \end{tabularx}
}{\Gls{gl:ab} \gls{ac:api} contained building blocks black box}
