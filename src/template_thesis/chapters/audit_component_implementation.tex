...
% \includenamedsvg{\includesvg[width=\textwidth,pretex=\relscale{0.005}]}{diagrams/monoskope-architecture.drawio}{Monoskope Architecture ~\citep{monoskope}}
...
% m8 was designed and developed to run mainly in a fintech enviorment where ensuring auditibalty is mandetory and detrmining roles permissions and actions of any user at any point of time is Complaint audits are 
