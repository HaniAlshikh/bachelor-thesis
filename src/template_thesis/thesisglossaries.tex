...
\newglossaryentry{gl:idpt}{
  name={idempotent},
  description={\todo{Idempotency is a property of a system or operation where the result of performing that operation multiple times is the same as performing it once. In other words, if an idempotent operation is performed multiple times, the end result is the same as performing it only once.}},
  }
